...
Use a single public web application in `apps/web` for:

- landing page
- documentation
- search
- shared navigation and footer
- shared typography and visual system
- SEO and metadata

The public web experience should use one consistent command-pipeline
visual language instead of separate marketing and docs products.
